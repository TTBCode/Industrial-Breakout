...
import IndustrialBreakout.Containers.ContainerGrinder;
...
public class GuiGrinder extends GuiContainer
{
    ...
    private static final ResourceLocation rl = new ResourceLocation(Reference.MOD_ID, "textures/gui/Grinder.png");
    ...
    {
        this.fontRendererObj.drawString("Grinder", 60, 6, 4210752);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        if (this.grinderInventory.hasEnergy())
        {
